...
public class UserDetailsPage extends PageBase {
	...
	By ProceedToCheckout_button = By
			.xpath("//p[@class='cart_navigation clearfix']//span[contains(text(),'Proceed to checkout')]");
	By form_form = By.xpath("//form[@id='form']");
	By pageHeading_label = By.xpath("//h1[@class='page-heading']");
	By userName_label = By.xpath("//a[@class='account']/span");
	...
	public void registerAccount(HashMap<String, String> userDetails, HashMap<String, String> addressDetails) {
		...
		waitTillElementVisible(TitleMrs_radio);
	...
	public String getPageHeading() {
		waitTillElementVisible(pageHeading_label);
		return getText(pageHeading_label);
	}
